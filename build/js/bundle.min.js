...
!(function (e, A, n) {
	...
	function a(e) {
		...
		l._config.enableClasses && ((A += " " + n + e.join(" " + n)), c ? (u.className.baseVal = A) : (u.className = A));
	}
	function t(e, A) {
		if ("object" == typeof e) for (var n in e) f(e, n) && t(n, e[n]);
			...
			(A = "function" == typeof A ? A() : A),
				1 == o.length ? (l[o[0]] = A) : (!l[o[0]] || l[o[0]] instanceof Boolean || (l[o[0]] = new Boolean(l[o[0]])), (l[o[0]][o[1]] = A)),
				a([(A && 0 != A ? "" : "no-") + o.join("-")]),
				l._trigger(e, A);
		}
		return l;
		...
		(function () {
			...
			for (var f in s)
				if (s.hasOwnProperty(f)) {
					if (
						((e = []),
						(A = s[f]).name && (e.push(A.name.toLowerCase()), A.options && A.options.aliases && A.options.aliases.length))
					)
						for (n = 0; n < A.options.aliases.length; n++) e.push(A.options.aliases[n].toLowerCase());
					for (a = o(A.fn, "function") ? A.fn() : A.fn, t = 0; t < e.length; t++)
						1 === (r = e[t].split(".")).length
							? (l[r[0]] = a)
							: (!l[r[0]] || l[r[0]] instanceof Boolean || (l[r[0]] = new Boolean(l[r[0]])), (l[r[0]][r[1]] = a)),
							i.push((a ? "" : "no-") + r.join("-"));
				}
		})(),
		a(i),
